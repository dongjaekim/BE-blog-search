...
public class BlogSearchService {
    ...
    public Mono<BlogSearchDetailDTO> getSearchResults(String keyword, String sort, Integer page, Integer size) throws InterruptedException {
        Mono<BlogSearchDetailDTO> output = null;
